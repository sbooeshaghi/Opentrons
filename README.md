...
<img src="media/pipetteJog.png" width="300"> *When the plunger moves to hard stop position, the screw simultaneously pushes the ejector button to reach ‘drop tip’ position. *
